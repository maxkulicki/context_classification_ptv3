"""
FOR-species20K Dataset for Point Cloud Classification

Individual tree point clouds from the FOR-species20K benchmark dataset
(~20K trees, 33 species across Europe). Format: .npy binary files with
x,y,z,nx,ny,nz columns.

Adapted from TreeScanPLDataset.
"""
...
class ForSpecies20KDataset(Dataset):
    def __init__(
        self,
        split="train",
        data_root="data/forspecies20k",
        class_names=None,
        transform=None,
        num_points=8192,
        ...
        record_name = f"forspecies20k_{self.split}"
    ...
    def get_data_list(self):
        ...
        split_path = os.path.join(
            self.data_root, "forspecies20k_{}.txt".format(self.split)
        )
