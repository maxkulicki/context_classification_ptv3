"""
PTv3 + AE + SINR concat fusion, aux heads (weight=0.5) — 10-class dual-val, 4-GPU / 120-epoch.
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_ae_sinr_cat_aux05_4gpu_120ep'
num_worker = 16
batch_size = 128
