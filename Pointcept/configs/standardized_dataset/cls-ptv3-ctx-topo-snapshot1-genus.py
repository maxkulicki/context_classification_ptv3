...
# Phase 1, Experiment 1.2: PTv3 + Topographic features (6-dim)
# Late concat fusion: PTv3 (512) + TopoEncoder (256) → 768 → 512 → num_classes
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(
                type="Collect",
                keys=("coord", "grid_coord", "category", "ctx_topo"),
                feat_keys=["coord"],
            ),
        ],
        test_mode=False,
    ...
    test=dict(
        ...
        test_cfg=dict(
            post_transform=[
                ...
                dict(
                    type="Collect",
                    keys=("coord", "grid_coord", "ctx_topo"),
                    feat_keys=["coord"],
                ),
            ],
            aug_transform=[
