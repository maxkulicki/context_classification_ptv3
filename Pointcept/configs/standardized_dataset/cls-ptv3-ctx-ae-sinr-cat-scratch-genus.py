...
# Phase 2, Experiment 2.1b: PTv3 + AE + SINR, simple deterministic concat fusion.
# Trained entirely from scratch (no pretrained backbone).
# Compare with Exp 2.1 (pretrained backbone) to isolate the value of pretraining.
...
# scheduler settings — uniform LR across all params (everything is random init)
epoch = 200
eval_epoch = 200
clip_grad = 1.0
