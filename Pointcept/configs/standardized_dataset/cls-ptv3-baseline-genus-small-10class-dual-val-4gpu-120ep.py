"""
PTv3 Small - Tree genus classification (10 classes), 4-GPU / 120-epoch config.
...
Controlled baseline for comparison with 120-epoch context fusion experiments.
Architecture identical to cls-ptv3-baseline-genus-small-10class-dual-val.py.
"""
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_small_4gpu_120ep'
num_worker = 16
batch_size = 128
