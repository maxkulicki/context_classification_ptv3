...
# PTv3 + AlphaEarth, pretrained backbone, 100 epochs.
# Weighted CrossEntropyLoss (sqrt-inverse frequency) — no Lovász.
# Weights computed from training set counts, normalized so mean=1.
# Class order: Abies Acer Alnus Betula Carpinus Fagus Fraxinus Larix Picea Pinus Pseudotsuga Quercus Tilia
# Counts:       402   81   100   685    120     480    21      63    819  4896   47         266    55
...
model = dict(
    ...
    criteria=[
        dict(
            ...
            loss_weight=1.0,
            ignore_index=-1,
            weight=[0.55, 1.23, 1.11, 0.42, 1.01, 0.51, 2.42, 1.40, 0.39, 0.16, 1.62, 0.68, 1.50],
        ),
    ],
)
