"""
PTv3 + AlphaEarth mid-fusion at enc2 — 10-class dual-val, 4-GPU / 120-epoch.
  AE embedding (256-d) injected after PTv3 encoder stage 2 (128-d features),
  two stages earlier than the stage-3 variant. Concat + Linear(384→128)+LN+GELU
  preserves the enc2 channel dim so enc3 and enc4 run unmodified.
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_ae_midfusion_stage2_4gpu_120ep'
num_worker = 16
batch_size = 128
