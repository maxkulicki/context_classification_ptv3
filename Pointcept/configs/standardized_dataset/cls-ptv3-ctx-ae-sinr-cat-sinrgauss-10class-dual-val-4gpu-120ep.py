"""
PTv3 + AlphaEarth + SINR deterministic concat fusion + SINR Gaussian noise augmentation
  ...
  Otherwise identical to cls-ptv3-ctx-ae-sinr-cat-10class-dual-val-4gpu-120ep.py.
"""
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_ae_sinr_cat_sinrgauss_4gpu_120ep'
num_worker = 16
batch_size = 128
