"""
PTv3 + SINR context fusion + Gaussian embedding noise — 10-class dual-val, 4-GPU / 120-epoch.
  Same as cls-ptv3-ctx-sinr-10class-dual-val-4gpu.py but with CtxGaussianNoise
  augmentation on ctx_sinr during training: scale-relative sigma=0.1, p_drop=0.2.
"""
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_sinr_gauss_4gpu_120ep'
num_worker = 16
batch_size = 128
