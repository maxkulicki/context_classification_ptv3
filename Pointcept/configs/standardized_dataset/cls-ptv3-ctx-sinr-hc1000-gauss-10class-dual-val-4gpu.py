"""
PTv3 + SINR context fusion (hard_cap_1000 checkpoint) + Gaussian embedding noise
— 10-class dual-val, 4-GPU / 120-epoch.

Same as cls-ptv3-ctx-sinr-gauss-10class-dual-val-4gpu.py but SINR embeddings
were extracted with:
    model_an_full_input_enc_sin_cos_hard_cap_num_per_class_1000.pt
instead of the default distilled_from_env checkpoint.
"""
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_sinr_hc1000_gauss_4gpu_120ep'
num_worker = 16
batch_size = 128
...
context_pth = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/data/snapshot_v1/context_features_sinr_hc1000.pth'
cache_data = False
