"""
PTv3 Small - Tree genus classification (6 classes: Abies, Betula, Fagus, Picea, Pinus, Quercus)
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_6class_mixed/ptv3_small_4gpu_100ep'
num_worker = 32
batch_size = 128
...
model = dict(
    ...
    criteria=[
        dict(
            ...
            loss_weight=1.0,
            ignore_index=-1,
            # sqrt-inverse-frequency weights (pool proportions), sum ~ 6
            # order: Abies, Betula, Fagus, Picea, Pinus, Quercus  (alphabetical = class index order)
            weight=[1.28, 1.02, 1.21, 0.75, 0.39, 1.35],
        ),
    ])
...
data_root = '/net/pr2/projects/plgrid/plggtreeseg/data/snapshot_6class_mixed_npy'
cache_data = False
class_names = ['Abies', 'Betula', 'Fagus', 'Picea', 'Pinus', 'Quercus']
