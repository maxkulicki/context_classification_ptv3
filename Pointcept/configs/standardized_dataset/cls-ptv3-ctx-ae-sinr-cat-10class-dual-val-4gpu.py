"""
PTv3 + AlphaEarth + SINR deterministic concat fusion — 10-class dual-val, 4-GPU / 200-epoch.
  Late concat fusion: PTv3 (512) + AEEncoder (256) + SINREncoder (256) → 1024 → num_classes
  Architecture: MultiCatCtxCls-v1m1 — both sources always active, no dropout.
  Dataset, loss, backbone, optimizer identical to cls-ptv3-ctx-ae-10class-dual-val-4gpu.py.
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_ae_sinr_cat_4gpu_200ep'
num_worker = 16
batch_size = 128
