"""
PTv3 Tiny - Tree genus classification (13 classes)
Minimal architecture for strong regularization baseline.
4 encoder stages, backbone_embed_dim=128.
"""
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot1/ptv3_tiny_8gpu_50ep'
num_worker = 32
batch_size = 256
...
model = dict(
    ...
    criteria=[
        dict(
            ...
            loss_weight=1.0,
            ignore_index=-1,
            # sqrt-inverse-frequency weights, sum ~ 13
            weight=[0.55, 1.23, 1.11, 0.42, 1.01, 0.51, 2.42, 1.40,
                    0.39, 0.16, 1.62, 0.68, 1.50],
        ),
    ])
