"""
PTv3 + AlphaEarth mid-fusion — 10-class dual-val, 4-GPU / 120-epoch.
  ...
  No aux heads, no vMF augmentation — clean mid-fusion baseline.
"""
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_ae_midfusion_4gpu_120ep'
num_worker = 16
batch_size = 128
