"""
PTv3 + AlphaEarth context fusion — 10-class dual-val, 4-GPU / 100-epoch, vMF augmentation.
  Identical to cls-ptv3-ctx-ae-10class-dual-val-4gpu.py, with CtxVMFAugment added to the
  train pipeline (after ToTensor, before Collect).  kappa=100 → ~8° mean angular deviation
  on S^63.
"""
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_ae_4gpu_100ep_vmf'
num_worker = 16
batch_size = 128
