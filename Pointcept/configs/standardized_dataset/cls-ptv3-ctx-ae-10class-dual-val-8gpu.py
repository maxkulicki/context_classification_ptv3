"""
PTv3 + AlphaEarth context fusion — 10-class dual-val dataset, 8-GPU / 200-epoch.
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_ae_8gpu_200ep'
num_worker = 32
batch_size = 256
...
wandb_key = None
mix_prob = 0
param_dicts = [dict(keyword='block', lr=0.0008)]
...
optimizer = dict(type='AdamW', lr=0.008, weight_decay=0.02)
scheduler = dict(
    type='OneCycleLR',
    max_lr=[0.008, 0.0008],
    pct_start=0.05,
