"""
PTv3 + SINR context fusion (hard_cap_100 checkpoint) + Gaussian embedding noise
...
test_only = False
seed = 3313067
save_path = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/Pointcept/exp/snapshot_10class_dual_val/ptv3_ctx_sinr_hc100_gauss_4gpu_120ep'
num_worker = 16
batch_size = 128
...
context_pth = '/net/pr2/projects/plgrid/plggtreeseg/context_classification_ptv3/data/snapshot_v1/context_features_sinr_hc100.pth'
cache_data = False
