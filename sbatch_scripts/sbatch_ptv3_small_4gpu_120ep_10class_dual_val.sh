...
#SBATCH --mem=128G
#SBATCH --output=ptv3_small_4gpu_120ep_10class_dual_val.%j.out
#SBATCH --error=ptv3_small_4gpu_120ep_10class_dual_val.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-baseline-genus-small-10class-dual-val-4gpu-120ep.py
EXP_DIR=$WD/exp/snapshot_10class_dual_val/ptv3_small_4gpu_120ep
