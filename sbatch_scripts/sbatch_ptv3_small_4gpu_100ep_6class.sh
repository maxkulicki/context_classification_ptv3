#!/bin/bash
#SBATCH --job-name=ptv3_small_4gpu_100ep_6class
...
#SBATCH --mem=128G
#SBATCH --output=ptv3_small_4gpu_100ep_6class.%j.out
#SBATCH --error=ptv3_small_4gpu_100ep_6class.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-baseline-genus-small-6class.py
EXP_DIR=$WD/exp/snapshot_6class_mixed/ptv3_small_4gpu_100ep
