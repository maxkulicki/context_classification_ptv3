#!/bin/bash
#SBATCH --job-name=ptv3_ctx_ae_sinr_scratch
...
#SBATCH --mem=256G
#SBATCH --output=ptv3_ctx_ae_sinr_cat_scratch.%j.out
#SBATCH --error=ptv3_ctx_ae_sinr_cat_scratch.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-ctx-ae-sinr-cat-scratch-genus.py
EXP_DIR=$WD/exp/snapshot1/ptv3_ctx_ae_sinr_cat_scratch_4gpu_200ep
