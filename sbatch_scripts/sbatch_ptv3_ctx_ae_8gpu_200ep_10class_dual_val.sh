#!/bin/bash
#SBATCH --job-name=ptv3_ae_10class_8gpu
...
#SBATCH --mem=256G
#SBATCH --output=ptv3_ctx_ae_8gpu_200ep_10class_dual_val.%j.out
#SBATCH --error=ptv3_ctx_ae_8gpu_200ep_10class_dual_val.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-ctx-ae-10class-dual-val-8gpu.py
EXP_DIR=$WD/exp/snapshot_10class_dual_val/ptv3_ctx_ae_8gpu_200ep
