#!/bin/bash
#SBATCH --job-name=ptv3_ae_temporal_aug
...
#SBATCH --mem=128G
#SBATCH --output=ptv3_ctx_ae_temporal_aug_4gpu_120ep_10class_dual_val.%j.out
#SBATCH --error=ptv3_ctx_ae_temporal_aug_4gpu_120ep_10class_dual_val.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-ctx-ae-temporal-aug-10class-dual-val-4gpu.py
EXP_DIR=$WD/exp/snapshot_10class_dual_val/ptv3_ctx_ae_temporal_aug_4gpu_120ep
