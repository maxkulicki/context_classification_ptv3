#!/bin/bash
#SBATCH --job-name=ptv3_xattn_aux
...
#SBATCH --mem=128G
#SBATCH --output=ptv3_ctx_ae_sinr_xattn_aux_4gpu_200ep_10class_dual_val.%j.out
#SBATCH --error=ptv3_ctx_ae_sinr_xattn_aux_4gpu_200ep_10class_dual_val.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-ctx-ae-sinr-xattn-aux-10class-dual-val-4gpu.py
EXP_DIR=$WD/exp/snapshot_10class_dual_val/ptv3_ctx_ae_sinr_xattn_aux_4gpu_200ep
