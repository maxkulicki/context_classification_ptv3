#!/bin/bash
#SBATCH --job-name=ptv3_small_4gpu_100ep
...
#SBATCH --mem=128G
#SBATCH --output=ptv3_small_4gpu_100ep.%j.out
#SBATCH --error=ptv3_small_4gpu_100ep.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-baseline-genus-small-v2.py
EXP_DIR=$WD/exp/baseline/ptv3_small_4gpu_100ep
