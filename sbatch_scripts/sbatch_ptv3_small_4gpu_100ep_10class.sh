#!/bin/bash
#SBATCH --job-name=ptv3_small_4gpu_100ep_10class
...
#SBATCH --mem=128G
#SBATCH --output=ptv3_small_4gpu_100ep_10class.%j.out
#SBATCH --error=ptv3_small_4gpu_100ep_10class.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-baseline-genus-small-10class.py
EXP_DIR=$WD/exp/snapshot_10class_mixed/ptv3_small_4gpu_100ep
