#!/bin/bash
#SBATCH --job-name=ptv3_snap1_normals
...
#SBATCH --mem=256G
#SBATCH --output=ptv3_snap1_normals.%j.out
#SBATCH --error=ptv3_snap1_normals.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-snapshot1-genus-normals.py
EXP_DIR=$WD/exp/snapshot1/ptv3_normals_8gpu_200ep
...
# NOTE: to resume correctly, pass BOTH:
