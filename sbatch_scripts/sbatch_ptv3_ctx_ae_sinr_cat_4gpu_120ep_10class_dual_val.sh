#!/bin/bash
#SBATCH --job-name=ptv3_ae_sinr_cat_120ep
...
#SBATCH --mem=128G
#SBATCH --output=ptv3_ctx_ae_sinr_cat_4gpu_120ep_10class_dual_val.%j.out
#SBATCH --error=ptv3_ctx_ae_sinr_cat_4gpu_120ep_10class_dual_val.%j.err
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-ctx-ae-sinr-cat-10class-dual-val-4gpu-120ep.py
EXP_DIR=$WD/exp/snapshot_10class_dual_val/ptv3_ctx_ae_sinr_cat_4gpu_120ep
