#!/bin/bash
# PTv3 + AlphaEarth, pretrained backbone, weighted CE, 100 epochs, 8 GPUs.

#SBATCH --job-name=ptv3_ctx_ae_wce
...
CONFIG=$WD/configs/standardized_dataset/cls-ptv3-ctx-ae-snapshot1-genus-pretrained-wce.py
EXP_DIR=$WD/exp/snapshot1/ptv3_ctx_ae_pretrained_wce_8gpu_100ep
